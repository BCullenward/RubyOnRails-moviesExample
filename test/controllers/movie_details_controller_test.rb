...
class MovieDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movie_detail" do
    assert_difference("MovieDetail.count") do
      post movie_details_url, params: { movie_detail: { movie_id: @movie_detail.movie_id, movie_imdbid: @movie_detail.movie_imdbid, movie_themoviedbid: @movie_detail.movie_themoviedbid, movie_thetvdbid: @movie_detail.movie_thetvdbid } }
    end
  ...
  test "should update movie_detail" do
    patch movie_detail_url(@movie_detail), params: { movie_detail: { movie_id: @movie_detail.movie_id, movie_imdbid: @movie_detail.movie_imdbid, movie_themoviedbid: @movie_detail.movie_themoviedbid, movie_thetvdbid: @movie_detail.movie_thetvdbid } }
